...
public class ManagedCardsAtmWithdrawalTest extends BaseTransactionsSetup {
    ...
    public void CardPurchase_PhysicalDebitCardNotActive_Success(){
        ...
        final int managedAccountExpectedBalance =
                (int) (managedCard.getInitialManagedAccountBalance() - purchaseAmount - TestHelper.getFees(corporateCurrency).get(FeeType.ATM_FEE).getAmount());
    ...
    public void CardPurchase_PrepaidCorporateForex_Success() throws SQLException {
        ...
        managedCardStatement
                ...
                .body("entry[0].availableBalanceAdjustment.currency", equalTo(corporateCurrency))
                .body("entry[0].availableBalanceAdjustment.amount", equalTo(Math.negateExact((int)(simulateCardPurchaseModel.getForexPadding() - purchaseFee))))
                .body("entry[0].actualBalanceAfter.currency", equalTo(corporateCurrency))
    ...
    public void CardPurchase_DebitCorporateExceedAvailableToSpendWithForex_Success() throws SQLException {
        ...
        final Long purchaseFee = TestHelper.getFees(baseCurrency).get(FeeType.ATM_FEE).getAmount();
    ...
    public void CardPurchase_MaxLimitWithMultipleAuths_DeniedSpendControl(){
        ...
        final String purchaseCode1 = simulateAtmWithdrawal(managedCard.getManagedCardId(),
                new CurrencyAmount(corporateCurrency, purchaseAmount1));


        final String purchaseCode2 = simulateAtmWithdrawal(managedCard.getManagedCardId(),
                new CurrencyAmount(corporateCurrency, purchaseAmount2));


        final String purchaseCode3 = simulateAtmWithdrawal(managedCard.getManagedCardId(),
    ...
    public void CardPurchase_KycLevel1WithinLimit_Success(){
        ...
        final Long purchaseFee = TestHelper.getFees(createConsumerModel.getBaseCurrency()).get(FeeType.ATM_FEE).getAmount();
