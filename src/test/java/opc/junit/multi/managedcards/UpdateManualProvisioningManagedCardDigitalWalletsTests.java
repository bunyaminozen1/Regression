...
public class UpdateManualProvisioningManagedCardDigitalWalletsTests extends AbstractUpdateManagedCardDigitalWalletsTests {
    ...
    public void PatchManagedCard_PropertyAndProfileConfigurationChecks_WalletsNotEnabled(final boolean isTokenisationEnabled,
                                                                                         final boolean isProfileEnabled) {
    ...
    @ParameterizedTest
    @MethodSource("walletsNotEnabledArguments")
    public void PatchManagedCard_PropertyAndProfileConfigurationChecksEnableProvisioning_WalletsNotEnabled(final boolean isTokenisationEnabled,
                                                                                                           final boolean isProfileEnabled) {
    ...
    @ParameterizedTest
    @MethodSource("walletsNotEnabledArguments")
    public void PatchManagedCard_PropertyAndProfileConfigurationChecksEnablePushProvisioning_PushProvisioningNotEnabled(final boolean isTokenisationEnabled,
                                                                                                                        final boolean isProfileEnabled) {
    ...
    @Test
    public void PatchManagedCard_NoConfigEnabledEnableManualProvisioning_WalletsNotEnabled() {
    ...
    @Test
    public void PatchManagedCard_NoConfigEnabledEnableProvisioning_WalletsNotEnabled() {
    ...
    @Test
    public void PatchManagedCard_NoConfigEnabled_SuccessProvisioningFalse() {
