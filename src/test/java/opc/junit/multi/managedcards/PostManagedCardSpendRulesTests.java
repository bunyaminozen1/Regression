...
public class PostManagedCardSpendRulesTests extends BaseManagedCardsSetup {
    ...
    @Test
    public void PostManagedCardSpendRules_SameIdempotencyRefSamePayload_Success(){
        ...
        responses.add(ManagedCardsService
                .postManagedCardsSpendRules(spendRulesModel, secretKey, managedCardId, corporateAuthenticationToken,
                        Optional.of(idempotencyReference)));
        responses.add(ManagedCardsService
                .postManagedCardsSpendRules(spendRulesModel, secretKey, managedCardId, corporateAuthenticationToken,
                        Optional.of(idempotencyReference)));

        responses.forEach(response -> response.then().statusCode(SC_NO_CONTENT));
    ...
    @Test
    public void PostManagedCardSpendRules_SameIdempotencyRefDifferentPayload_BadRequest(){
        ...
        ManagedCardsService
                .postManagedCardsSpendRules(spendRulesModel.build(), secretKey, managedCardId, corporateAuthenticationToken,
                        Optional.of(idempotencyReference))
                .then()
                .statusCode(SC_NO_CONTENT);

        ManagedCardsService
                .postManagedCardsSpendRules(spendRulesModel.setBlockedMerchantCategories(List.of("1234")).build(), secretKey, managedCardId, corporateAuthenticationToken,
                        Optional.of(idempotencyReference))
                .then()
        ...
        assertSpendRules(response, spendRulesModel.setBlockedMerchantCategories(List.of("test")).build(), corporateCurrency, corporatePrepaidProfileRules, CardMode.PREPAID, false);
    }

    @Test
    public void PostManagedCardSpendRules_DifferentIdempotencyRefSamePayload_AlreadySet(){
        ...
        final SpendRulesModel spendRulesModel = SpendRulesModel.DefaultSpendRulesModel()
                .setSpendLimit(new ArrayList<>()).build();

        ManagedCardsService
                .postManagedCardsSpendRules(spendRulesModel, secretKey, managedCardId, corporateAuthenticationToken,
                        Optional.of(RandomStringUtils.randomAlphanumeric(20)))
                .then()
                .statusCode(SC_NO_CONTENT);

        ManagedCardsService
                .postManagedCardsSpendRules(spendRulesModel,
                        secretKey, managedCardId, corporateAuthenticationToken, Optional.of(RandomStringUtils.randomAlphanumeric(20)))
                .then()
                .statusCode(SC_CONFLICT)
    ...
    @Test
    public void PostManagedCardSpendRules_DifferentIdempotencyRefDifferentPayload_AlreadySet(){
    ...
    @Test
    public void PostManagedCardSpendRules_SameIdempotencyRefSamePayloadWithChange_Success(){
        ...
        final SpendRulesModel patchSpendRulesModel =
                SpendRulesModel.DefaultSpendRulesModel()
                        .setBlockedMerchantCategories(List.of("1234"))
                        .setSpendLimit(new ArrayList<>())
                        .build();

        ManagedCardsService.patchManagedCardsSpendRules(patchSpendRulesModel, secretKey, managedCardId,
        ...
        assertSpendRules(response, patchSpendRulesModel, corporateCurrency, corporatePrepaidProfileRules, CardMode.PREPAID, false);
    }

    @Test
    public void PostManagedCardSpendRules_SameIdempotencyRefSamePayloadDifferentCard_Success(){

        final String managedCardId =
                createPrepaidManagedCard(corporatePrepaidManagedCardsProfileId, corporateCurrency, corporateAuthenticationToken)
                        .getManagedCardId();

        final String managedCardId1 =
                createPrepaidManagedCard(corporatePrepaidManagedCardsProfileId, corporateCurrency, corporateAuthenticationToken)
                        .getManagedCardId();
        ...
        ManagedCardsService
                .postManagedCardsSpendRules(spendRulesModel, secretKey, managedCardId1, corporateAuthenticationToken,
                        Optional.of(idempotencyReference))
            .then()
            .statusCode(SC_NO_CONTENT);
        ...
        final ValidatableResponse response1 =
                ManagedCardsService
                        .getManagedCardsSpendRules(secretKey, managedCardId1, corporateAuthenticationToken)
                        .then()
                        .statusCode(SC_OK);

        assertSpendRules(response, spendRulesModel, corporateCurrency, corporatePrepaidProfileRules, CardMode.PREPAID, false);
        assertSpendRules(response1, spendRulesModel, corporateCurrency, corporatePrepaidProfileRules, CardMode.PREPAID, false);
    }

    @Test
    public void PostManagedCardSpendRules_SameIdempotencyRefDifferentPayloadDifferentCard_Success(){
        ...
        final SpendRulesModel spendRulesModel1 = SpendRulesModel.DefaultSpendRulesModel()
                .setBlockedMerchantCategories(List.of("1234"))
                .setSpendLimit(new ArrayList<>()).build();
        ...
        ManagedCardsService
                .postManagedCardsSpendRules(spendRulesModel1, secretKey, managedCardId1, corporateAuthenticationToken,
                        Optional.of(idempotencyReference))
                .then()
                .statusCode(SC_NO_CONTENT);
        ...
        assertSpendRules(response, spendRulesModel, corporateCurrency, corporatePrepaidProfileRules, CardMode.PREPAID, false);
        assertSpendRules(response1, spendRulesModel1, corporateCurrency, corporatePrepaidProfileRules, CardMode.PREPAID, false);
    }

    @Test
    public void PostManagedCardSpendRules_SameIdempotencyRefDifferentPayloadInitialCallFailed_Success(){
        ...
        ManagedCardsHelper.deleteSpendRules(secretKey, managedCardId, corporateAuthenticationToken);
    ...
    @Test
    public void PostManagedCardSpendRules_SameIdempotencyRefDifferentPayloadInitialCallFailed_BadRequest(){
        ...
        ManagedCardsService
                .postManagedCardsSpendRules(spendRulesModel.setSpendLimit(new ArrayList<>()).build(), secretKey, managedCardId, corporateAuthenticationToken,
                        Optional.of(idempotencyReference))
                .then()
                .statusCode(SC_BAD_REQUEST)
                .body("message", equalTo("Payloads do not match for the same idempotency-ref."));
    ...
    @Test
    public void PostManagedCardSpendRules_SameIdempotencySameReferenceExpired_AlreadySet() throws InterruptedException {
        final String managedCardId =
                createPrepaidManagedCard(corporatePrepaidManagedCardsProfileId, corporateCurrency, corporateAuthenticationToken)
                        .getManagedCardId();
    ...
    @Test
    public void PostManagedCardSpendRules_LongIdempotencyRef_RequestTooLong(){
    ...
    public void PostManagedCardSpendRules_UnknownManagedCardId_NotFound() {
        ...
        ManagedCardsService
                .postManagedCardsSpendRules(spendRulesModel, secretKey, RandomStringUtils.randomNumeric(18), corporateAuthenticationToken, Optional.empty())
                .then()
    ...
    public void PostManagedCardSpendRules_NoManagedCardId_NotFound() {
        ...
        ManagedCardsService
                .postManagedCardsSpendRules(spendRulesModel, secretKey, "", corporateAuthenticationToken, Optional.empty())
                .then()
                .statusCode(SC_METHOD_NOT_ALLOWED);
    }

    @Test
    public void PostManagedCardSpendRules_CrossIdentityCheck_NotFound(){
        final String managedCardId =
                createPrepaidManagedCard(consumerPrepaidManagedCardsProfileId, consumerV2Currency, consumerV2AuthenticationToken)
                        .getManagedCardId();
    ...
    @Test
    public void PostManagedCardSpendRules_CrossSameIdentityTypeCheck_NotFound(){
        ...
        ManagedCardsService
                .postManagedCardsSpendRules(spendRulesModel, secretKey, managedCardId, newConsumer.getRight(), Optional.empty())
                .then().statusCode(SC_NOT_FOUND);
    }
    ...
    public void PostManagedCardSpendRules_InvalidToken_Unauthorised(){
        ...
        ManagedCardsService
                .postManagedCardsSpendRules(spendRulesModel, secretKey, managedCardId, RandomStringUtils.randomAlphanumeric(5), Optional.empty())
                .then()
    ...
    public void PostManagedCardSpendRules_InvalidApiKey_Unauthorised(){
        ...
        ManagedCardsService
                .postManagedCardsSpendRules(spendRulesModel, "abc", RandomStringUtils.randomNumeric(18), corporateAuthenticationToken, Optional.empty())
    ...
    public void PostManagedCardSpendRules_NoApiKey_BadRequest(){
        ...
        ManagedCardsService
                .postManagedCardsSpendRules(spendRulesModel, "", RandomStringUtils.randomNumeric(18), corporateAuthenticationToken, Optional.empty())
    ...
    @Test
    public void PostManagedCardSpendRules_RootUserLoggedOut_Unauthorised(){
        ...
        ManagedCardsService
                .postManagedCardsSpendRules(spendRulesModel, secretKey, RandomStringUtils.randomNumeric(18), token, Optional.empty())
                .then().statusCode(SC_UNAUTHORIZED);
    }

    @Test
    public void PostManagedCardSpendRules_BackofficeCorporateImpersonator_Forbidden(){
        final String managedCardId =
                createPrepaidManagedCard(corporatePrepaidManagedCardsProfileId, corporateCurrency, corporateAuthenticationToken)
                        .getManagedCardId();
        ...
        ManagedCardsService
                .postManagedCardsSpendRules(spendRulesModel, secretKey, managedCardId, getBackofficeImpersonateToken(corporateId, IdentityType.CORPORATE), Optional.empty())
                .then()
                .statusCode(SC_FORBIDDEN);
    }

    @Test
    public void PostManagedCardSpendRules_BackofficeConsumerImpersonator_Forbidden(){
        final String managedCardId =
                createPrepaidManagedCard(consumerPrepaidManagedCardsProfileId, consumerV2Currency, consumerV2AuthenticationToken)
                        .getManagedCardId();
        ...
        ManagedCardsService
                .postManagedCardsSpendRules(spendRulesModel, secretKey, managedCardId, getBackofficeImpersonateToken(consumerV2Id, IdentityType.CONSUMER), Optional.empty())
                .then()
                .statusCode(SC_FORBIDDEN);
    }
    ...
    public void PostManagedCardSpendRules_DebitCorporate_AllowedNullsAsItem_Success(){
        ...
        ManagedCardsService
            .postManagedCardsSpendRules(spendRulesModelWithNulls, secretKey, managedCardId, corporateAuthenticationToken, Optional.empty())
            .then()
            .statusCode(SC_NO_CONTENT);
    ...
    private void assertSpendRules(final ValidatableResponse response,
        ...
        response
                ...
                .body("cardLevelSpendRules.minTransactionAmount", equalTo(spendRulesModel.getMinTransactionAmount() == null ?
                        null :  spendRulesModel.getMinTransactionAmount().intValue()))
                .body("profileLevelSpendRules.allowedMerchantCategories", equalTo(spendRulesResponseModel.getAllowedMerchantCategories().isEmpty() ? null : spendRulesResponseModel.getAllowedMerchantCategories()))
                .body("profileLevelSpendRules.blockedMerchantCategories", equalTo(spendRulesResponseModel.getBlockedMerchantCategories().isEmpty() ? null : spendRulesResponseModel.getBlockedMerchantCategories()))
                .body("profileLevelSpendRules.allowedMerchantIds", equalTo(spendRulesResponseModel.getAllowedMerchantIds().isEmpty() ? null : spendRulesResponseModel.getAllowedMerchantIds()))
                .body("profileLevelSpendRules.blockedMerchantIds", equalTo(spendRulesResponseModel.getBlockedMerchantIds().isEmpty() ? null : spendRulesResponseModel.getBlockedMerchantIds()))
                ...
                .body("profileLevelSpendRules.allowedMerchantCountries", equalTo(spendRulesResponseModel.getAllowedMerchantCountries().isEmpty() ? null : spendRulesResponseModel.getAllowedMerchantCountries()))
                .body("profileLevelSpendRules.blockedMerchantCountries", equalTo(spendRulesResponseModel.getBlockedMerchantCountries().isEmpty() ? null : spendRulesResponseModel.getBlockedMerchantCountries()))
