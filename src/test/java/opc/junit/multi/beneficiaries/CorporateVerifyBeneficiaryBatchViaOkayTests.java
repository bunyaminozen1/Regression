...
public class CorporateVerifyBeneficiaryBatchViaOkayTests extends AbstractVerifyBeneficiaryBatchViaOkayTests{
  ...
  private void sourceSetup() {
    ...
    SecureHelper.enrolAndVerifyBiometric(identityId, sharedKey, secretKey, identityToken);
  }
