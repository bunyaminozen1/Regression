...
public class CardDetailsSecurityDisabledTests extends BaseSecurityConfigurationTests {
    ...
    public void SecurityDisabled_GetManagedCardsDetailsTokenized_Success(){
        ...
        assertTrue(isNotTokenized(jsonPath.get("cards[0].cardNumber.value"), consumerAssociateRandom, consumerAuthenticationToken));
        assertTrue(isNotTokenized(jsonPath.get("cards[0].cvv.value"), consumerAssociateRandom, consumerAuthenticationToken));
    }
