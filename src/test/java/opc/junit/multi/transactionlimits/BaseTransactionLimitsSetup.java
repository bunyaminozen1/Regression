...
@Tag(MultiTags.MULTI)
@Tag(MultiTags.LIMITS)
public class BaseTransactionLimitsSetup {
    ...
    public static void GlobalSetup() {
        ...
        adminTenantImpersonationToken = AdminService.impersonateTenant(applicationOne.getInnovatorId(), adminToken);
    }
}
