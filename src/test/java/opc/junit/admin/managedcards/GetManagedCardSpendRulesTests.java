...
public class GetManagedCardSpendRulesTests extends BaseManagedCardsSetup {
    ...
    public void GetManagedCardSpendRules_DebitCorporate_Success(final LimitInterval interval){
        ...
        AdminService
                .addCardSpendRules(spendRulesModel, managedCard.getManagedCardId(), adminToken)
                .then()
                .statusCode(SC_NO_CONTENT);

        final ValidatableResponse response =
                AdminService
                        .getCardSpendRules(adminToken, managedCard.getManagedCardId())
                        .then()
                        .statusCode(SC_OK);
    ...
    public void GetManagedCardSpendRules_PrepaidCorporate_Success(){
        ...
        AdminService
                .addCardSpendRules(spendRulesModel, corporatePrepaidManagedCard.getManagedCardId(), adminToken)
                .then()
                .statusCode(SC_NO_CONTENT);

        final ValidatableResponse response =
                AdminService
                        .getCardSpendRules(adminToken, corporatePrepaidManagedCard.getManagedCardId())
                        .then()
                        .statusCode(SC_OK);
    ...
    public void GetManagedCardSpendRules_PrepaidConsumerV2_Success(){
        ...
        AdminService
                .addCardSpendRules(spendRulesModel, consumerV2PrepaidManagedCard.getManagedCardId(), adminToken)
                .then()
                .statusCode(SC_NO_CONTENT);

        final ValidatableResponse response =
                AdminService
                        .getCardSpendRules(adminToken, consumerV2PrepaidManagedCard.getManagedCardId())
                        .then()
                        .statusCode(SC_OK);
    ...
    public void GetManagedCardSpendRules_UnknownManagedCardId_NotFound() {
        AdminService.getCardSpendRules(adminToken, RandomStringUtils.randomNumeric(18))
                .then()
