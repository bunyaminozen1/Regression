...
public class GetConsumerEmailTemplateTests extends BaseEmailTemplateSetup {
    ...
    public static void TestSetup(){
        Arrays.stream(EmailTemplateType.values()).filter(x -> x.name().contains("CONSUMER")).forEach(template -> {
            ...
            AdminService.setConsumerProfileTemplate(emailTemplateModel, programmeId, consumerProfileId, adminToken)
                    .then()
    ...
    public void GetTemplate_SpecificContext_Success(){
        emailTemplates.forEach(template -> {
            ...
            AdminService.getConsumerProfileTemplate(emailTemplateContextModel, programmeId, consumerProfileId, adminToken)
                    .then()
                    .statusCode(SC_OK)
    ...
    public void GetTemplate_UnknownProfileId_NotFound() {
        ...
        AdminService.getConsumerProfileTemplate(emailTemplateContextModel, programmeId,
    ...
    public void GetTemplate_UnknownProgrammeId_NotFound() {
        ...
        AdminService.getConsumerProfileTemplate(emailTemplateContextModel, RandomStringUtils.randomNumeric(18),
