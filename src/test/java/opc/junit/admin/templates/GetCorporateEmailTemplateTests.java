...
public class GetCorporateEmailTemplateTests extends BaseEmailTemplateSetup {
    ...
    public void GetTemplate_UnknownProfileId_NotFound() {
        ...
        AdminService.getCorporateProfileTemplate(emailTemplateContextModel, programmeId,
    ...
    public void GetTemplate_UnknownProgrammeId_NotFound() {
        ...
        AdminService.getCorporateProfileTemplate(emailTemplateContextModel, RandomStringUtils.randomNumeric(18),
