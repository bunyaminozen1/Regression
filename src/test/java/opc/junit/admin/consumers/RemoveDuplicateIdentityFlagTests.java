...
public class RemoveDuplicateIdentityFlagTests extends BaseConsumersSetup{
    ...
    public void Consumers_RejectedDuplicateIdentityRemoveFlag_Success() throws SQLException {
        ...
        AdminService.removeDuplicateIdentityFlag(removeComment, secondConsumer.getLeft(), adminImpersonatedToken)
                .then()
    ...
    public void Consumers_NotDuplicateIdentityRemoveFlag_NotADuplicate() throws SQLException {
        ...
        AdminService.removeDuplicateIdentityFlag(removeComment, consumer.getLeft(), adminImpersonatedToken)
                .then()
                .statusCode(SC_CONFLICT)
    ...
    public void Consumers_RejectedDuplicateIdentityRemoveFlagWithoutComment_BadRequest() {
        ...
        AdminService.removeDuplicateIdentityFlag(removeDuplicateIdentityFlagModel, consumer.getLeft(), adminImpersonatedToken)
                .then()
                .statusCode(SC_BAD_REQUEST)
                .body("message", equalTo("JSON request violated validation rules"))
                .body("validation.fields[0].name", equalTo("comment"))
    ...
    @Test
    public void Consumers_RemoveFlagDifferentWithoutIdentityId_MethodNotAllowed() {

        AdminService.removeDuplicateIdentityFlag(removeComment, "", adminImpersonatedToken)
                .then()
    ...
    public void Consumers_RemoveFlagDifferentInvalidIdentityId_NotFound() {
        ...
        AdminService.removeDuplicateIdentityFlag(removeComment, RandomStringUtils.randomNumeric(18), adminImpersonatedToken)
                .then()
