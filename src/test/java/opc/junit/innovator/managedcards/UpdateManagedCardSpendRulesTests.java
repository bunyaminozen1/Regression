...
public class UpdateManagedCardSpendRulesTests extends BaseManagedCardsSetup {
    ...
    public void PatchManagedCardSpendRules_PrepaidCorporate_SpendLimitNotSupportedForPrepaidMode(){
        ...
        InnovatorService
                .addCardSpendRules(spendRulesModel.build(), managedCardId, innovatorToken)
                .then()
        ...
        InnovatorService
                .updateCardSpendRules(updateSpendRulesModel, managedCardId, innovatorToken)
                .then()
    ...
    public void PatchManagedCardSpendRules_PrepaidCorporateJustSpendRules_Success(){
        ...
        InnovatorService
                .updateCardSpendRules(updatedSpendRulesModel, managedCardId, innovatorToken)
                .then()
                .statusCode(SC_NO_CONTENT);
    ...
    public void PatchManagedCardSpendRules_UnknownManagedCardId_NotFound() {
        ...
        InnovatorService
                .updateCardSpendRules(spendRulesModel, RandomStringUtils.randomNumeric(18), innovatorToken)
                .then()
    ...
    public void PatchManagedCardSpendRules_NoManagedCardId_NotFound() {
        ...
        InnovatorService
                .updateCardSpendRules(spendRulesModel, "", innovatorToken)
                .then()
                .statusCode(SC_NOT_FOUND);
    }
    ...
    public void PatchManagedCardSpendRules_CheckAllFields_Success(final UpdateSpendRulesModel spendRulesModel){
        ...
        InnovatorService
                .addCardSpendRules(initialSpendRulesModel, managedCardId, innovatorToken)
                .then()
                .statusCode(SC_NO_CONTENT);

        InnovatorService
                .updateCardSpendRules(spendRulesModel, managedCardId, innovatorToken)
                .then()
                .statusCode(SC_NO_CONTENT);
