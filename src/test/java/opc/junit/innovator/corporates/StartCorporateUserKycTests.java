...
public class StartCorporateUserKycTests extends BaseCorporatesSetup{
    ...
    public void StartUserKyc_KycNotStarted_Success(){
        ...
        InnovatorService.startCorporateUserKyc(corporateId, corporateUserId, innovatorToken)
                .then()
                .statusCode(SC_OK)
    ...
    public void StartUserKyc_KycInitiated_Success(){
        ...
        final String kycReferenceId = InnovatorHelper.startCorporateUserKyc(corporateId, corporateUserId, innovatorToken);
    ...
    public void StartUserKyc_EmailNotVerified_EmailNotVerified() {
        ...
        InnovatorService.startCorporateUserKyc(corporateId, userId, innovatorToken)
                .then()
                .statusCode(SC_CONFLICT)
    ...
    public void StartUserKyc_OtherIdentityTypeUser_Forbidden(){
        ...
        InnovatorService.startCorporateUserKyc(corporateId, user.getLeft(), user.getRight())
                .then()
    ...
    public void StartUserKyc_OtherIdentityTypeRoot_Forbidden(){
        ...
        InnovatorService.startCorporateUserKyc(corporateId, user.getLeft(), consumer.getRight())
                .then()
                .statusCode(SC_FORBIDDEN);
    }
    ...
    public void StartUserKyc_UnknownUserId_NotFound(){
        ...
        InnovatorService.startCorporateUserKyc(corporateId, RandomStringUtils.randomNumeric(18), innovatorToken)
                .then()
                .statusCode(SC_NOT_FOUND);
    }
