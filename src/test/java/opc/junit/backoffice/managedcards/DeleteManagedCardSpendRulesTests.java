...
public class DeleteManagedCardSpendRulesTests extends BaseManagedCardsSetup {
    ...
    public static void Setup(){
        ...
        consumerV1ImpersonateToken = BackofficeHelper.impersonateIdentityAccessToken(consumerV1Id, IdentityType.CONSUMER, secretKey);
    ...
    public void DeleteManagedCardSpendRules_PrepaidConsumerKycLevelV1_Success(final Currency currency){
        ...
        BackofficeMultiService
                .deleteManagedCardsSpendRules(secretKey, managedCardId, consumerV1ImpersonateToken)
                .then()
                .statusCode(SC_NO_CONTENT);
    ...
    public void DeleteManagedCardSpendRules_PrepaidConsumerKycLevelV2_Success(){
        ...
        BackofficeMultiService
                .deleteManagedCardsSpendRules(secretKey, managedCardId, consumerV2ImpersonateToken)
                .then()
                .statusCode(SC_NO_CONTENT);
    ...
    public void DeleteManagedCardSpendRules_UnknownManagedCardId_NotFound() {
        ...
        BackofficeMultiService
                .deleteManagedCardsSpendRules(secretKey, RandomStringUtils.randomNumeric(18), corporateImpersonateToken)
                .then()
    ...
    @Test
    public void DeleteManagedCardSpendRules_CrossIdentityImpersonation_Unauthorised() {
    ...
    @Test
    public void DeleteManagedCardSpendRules_OtherCorporateIdentityImpersonation_Unauthorised() {
        ...
        BackofficeMultiService
                .deleteManagedCardsSpendRules(secretKey, managedCardId, token)
                .then()
                .statusCode(SC_UNAUTHORIZED);
    }

    @Test
    public void DeleteManagedCardSpendRules_OtherConsumerIdentityImpersonation_Unauthorised() {
    ...
    @Test
    public void DeleteManagedCardSpendRules_CorporateToken_Forbidden(){
    ...
    @Test
    public void DeleteManagedCardSpendRules_ConsumerToken_Forbidden(){

        BackofficeMultiService
                .deleteManagedCardsSpendRules(secretKey, RandomStringUtils.randomNumeric(18), consumerV2AuthenticationToken)
                .then().statusCode(SC_FORBIDDEN);
    }
