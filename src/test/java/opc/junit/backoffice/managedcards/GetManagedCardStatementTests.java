...
public class GetManagedCardStatementTests extends BaseManagedCardsSetup{
    ...
    public void GetManagedCardStatement_Corporate_Success(){
        assertSuccessfulResponse(BackofficeMultiService
                        .getManagedCardStatement(secretKey, corporateManagedCard.getManagedCardId(), corporateImpersonateToken, Optional.empty(), AcceptedResponse.JSON)
                        .then()
                        .statusCode(SC_OK),
    ...
    public void GetManagedCardStatement_Consumer_Success(){
        assertSuccessfulResponse(BackofficeMultiService
                        .getManagedCardStatement(secretKey, consumerManagedCard.getManagedCardId(), consumerImpersonateToken, Optional.empty(), AcceptedResponse.JSON)
                        .then()
                        .statusCode(SC_OK),
    ...
    public void GetManagedCardStatement_WithAllFilters_Success(){
        ...
        assertSuccessfulResponse(BackofficeMultiService
                        .getManagedCardStatement(secretKey, consumerManagedCard.getManagedCardId(), consumerImpersonateToken, Optional.of(filters), AcceptedResponse.JSON)
                        .then()
                        .statusCode(SC_OK),
                consumerCurrency, consumerManagedAccount);
    }
    ...
    public void GetManagedCardStatement_CsvAcceptedResponseCheck_Success(){
        ...
        BackofficeMultiService
                .getManagedCardStatement(secretKey, consumerManagedCard.getManagedCardId(), consumerImpersonateToken, Optional.empty(), AcceptedResponse.CSV)
                .then()
                .statusCode(SC_OK);
    }
    ...
    public void GetManagedCardStatement_NoAcceptHeader_DefaultToJsonSuccess(){
        assertSuccessfulResponse(BackofficeMultiService
                .getManagedCardStatement(secretKey, corporateManagedCard.getManagedCardId(), corporateImpersonateToken, Optional.empty(), Optional.empty())
                .then()
    ...
    public void GetManagedCardStatement_JsonInAcceptHeader_JsonSuccess(){
        ...
        assertSuccessfulResponse(BackofficeMultiService
                .getManagedCardStatement(secretKey, corporateManagedCard.getManagedCardId(), corporateImpersonateToken, Optional.empty(), Optional.of(headers))
                .then()
                .statusCode(SC_OK), corporateCurrency, corporateManagedAccount);
    }
    ...
    public void GetManagedCardStatement_CsvInAcceptHeader_CsvSuccess(){
        ...
        // TODO check csv items in response
        BackofficeMultiService
                .getManagedCardStatement(secretKey, consumerManagedCard.getManagedCardId(), consumerImpersonateToken, Optional.empty(), Optional.of(headers))
                .then()
                .statusCode(SC_OK);
    }
    ...
    public void GetManagedCardStatement_FilterFromMultipleEntries_Success() {
        ...
        final Long latestTimestamp =
                BackofficeMultiService
                        .getManagedCardStatement(secretKey, consumerManagedCard.getManagedCardId(), consumerImpersonateToken,
    ...
    public void GetManagedCardStatement_CheckOrdering_Success(final String order){
        ...
        final JsonPath response = BackofficeMultiService
                .getManagedCardStatement(secretKey, corporateManagedCard.getManagedCardId(), corporateImpersonateToken, Optional.of(filters), AcceptedResponse.JSON)
                .then()
                .statusCode(SC_OK)
                .extract()
                .jsonPath();
    ...
    public void GetManagedCardStatement_InvalidApiKey_Unauthorised(){
        BackofficeMultiService
                .getManagedCardStatement("abc", corporateManagedCard.getManagedCardId(), corporateImpersonateToken, Optional.empty(), AcceptedResponse.JSON)
    ...
    public void GetManagedCardStatement_NoApiKey_BadRequest(){
        BackofficeMultiService
                .getManagedCardStatement("", corporateManagedCard.getManagedCardId(), corporateImpersonateToken, Optional.empty(), AcceptedResponse.JSON)
    ...
    @Test
    public void GetManagedCardStatement_RootUserLoggedOut_Forbidden(){
    ...
    public void GetManagedCardStatement_CrossIdentityCheck_NotFound(){
        BackofficeMultiService
                .getManagedCardStatement(secretKey, corporateManagedCard.getManagedCardId(), consumerImpersonateToken, Optional.empty(), AcceptedResponse.JSON)
    ...
    public void GetManagedCardStatement_UnknownManagedCardId_NotFound() {
        BackofficeMultiService
                .getManagedCardStatement(secretKey, RandomStringUtils.randomNumeric(18), corporateImpersonateToken, Optional.empty(), AcceptedResponse.JSON)
                .then()
    ...
    public void GetManagedCardStatement_NoManagedCardId_NotFound() {
        BackofficeMultiService
                .getManagedCardStatement(secretKey, "", corporateImpersonateToken, Optional.empty(), AcceptedResponse.JSON)
                .then()
                .statusCode(SC_BAD_REQUEST);
    }

    @Test
    public void GetManagedCardStatement_CorporateAuthToken_Forbidden(){
        BackofficeMultiService
                .getManagedCardStatement(secretKey, corporateManagedCard.getManagedCardId(),
                        corporateAuthenticationToken, Optional.empty(), AcceptedResponse.JSON)
                .then()
                .statusCode(SC_FORBIDDEN);
    }

    @Test
    public void GetManagedCardStatement_ConsumerAuthToken_Forbidden(){
        BackofficeMultiService
                .getManagedCardStatement(secretKey, consumerManagedCard.getManagedCardId(),
                        consumerAuthenticationToken, Optional.empty(), AcceptedResponse.JSON)
                .then()
                .statusCode(SC_FORBIDDEN);
    }
