...
import opc.junit.helpers.multi.*;
...
import static opc.enums.opc.ManagedInstrumentType.*;
...
//        consumerImpersonateToken = BackofficeHelper.impersonateIdentity(consumerId, IdentityType.CONSUMER, secretKey);
    ...
    public void TransferFunds_CorporateMaToMa_Success(final Currency currency) {
        ...
        assertSuccessfulTransfer(Pair.of(managedAccounts.get(0).getLeft(), MANAGED_ACCOUNTS),
                Pair.of(managedAccounts.get(1).getLeft(), MANAGED_ACCOUNTS), currency.name(), sendAmount, corporateImpersonateToken);
    ...
    public void TransferFunds_ConsumerMaToMa_Success() {
        ...
        assertSuccessfulTransfer(Pair.of(managedAccounts.get(0).getLeft(), MANAGED_ACCOUNTS),
                Pair.of(managedAccounts.get(1).getLeft(), MANAGED_ACCOUNTS), consumerCurrency, transferAmount, consumerImpersonateToken);
    ...
    public void TransferFunds_CorporateMcToMc_Success() {
        ...
        assertSuccessfulTransfer(Pair.of(managedCards.get(0).getLeft(), MANAGED_CARDS),
                Pair.of(managedCards.get(1).getLeft(), MANAGED_CARDS), corporateCurrency, transferAmount, corporateImpersonateToken);
    ...
    public void TransferFunds_ConsumerMcToMc_Success() {
        ...
        assertSuccessfulTransfer(Pair.of(managedCards.get(0).getLeft(), MANAGED_CARDS),
                Pair.of(managedCards.get(1).getLeft(), MANAGED_CARDS), consumerCurrency, transferAmount, consumerImpersonateToken);
    ...
    public void TransferFunds_CorporateMcToMa_Success() {
        ...
        assertSuccessfulTransfer(Pair.of(managedCard.getLeft(), MANAGED_CARDS),
                Pair.of(managedAccount.getLeft(), MANAGED_ACCOUNTS), corporateCurrency, transferAmount, corporateImpersonateToken);
    ...
    public void TransferFunds_ConsumerMcToMa_Success() {
        ...
        assertSuccessfulTransfer(Pair.of(managedCard.getLeft(), MANAGED_CARDS),
                Pair.of(managedAccount.getLeft(), MANAGED_ACCOUNTS), consumerCurrency, transferAmount, consumerImpersonateToken);
    ...
    public void TransferFunds_CorporateMaToMc_Success() {
        ...
        assertSuccessfulTransfer(Pair.of(managedAccount.getLeft(), MANAGED_ACCOUNTS),
                Pair.of(managedCard.getLeft(), MANAGED_CARDS), corporateCurrency, transferAmount, corporateImpersonateToken);
    ...
    public void TransferFunds_ConsumerMaToMc_Success() {
        ...
        assertSuccessfulTransfer(Pair.of(managedAccount.getLeft(), MANAGED_ACCOUNTS),
                Pair.of(managedCard.getLeft(), MANAGED_CARDS), consumerCurrency, transferAmount, consumerImpersonateToken);
    ...
    public void TransferFunds_SourceManagedAccountLinkedToDebitCard_Success() {
        ...
        assertSuccessfulTransfer(Pair.of(managedAccounts.get(0).getLeft(), MANAGED_ACCOUNTS),
                Pair.of(managedAccounts.get(1).getLeft(), MANAGED_ACCOUNTS), corporateCurrency, transferAmount, corporateImpersonateToken);
    ...
    public void TransferFunds_RequiredFieldsOnly_Success() {
        ...
        BackofficeMultiService.transferFunds(transferFundsModel, secretKey, corporateImpersonateToken, Optional.empty())
                .then()
                .statusCode(SC_OK)
    ...
    public void TransferFunds_SameIdempotencyRefSamePayload_Success() {
        ...
        final String authCorporateImpersonateToken = BackofficeHelper.impersonateIdentity(corporateUserId, IdentityType.CORPORATE, secretKey);
        ...
        responses.add(BackofficeMultiService.transferFunds(transferFundsModel, secretKey, authCorporateImpersonateToken, Optional.of(idempotencyReference)));
        responses.add(BackofficeMultiService.transferFunds(transferFundsModel, secretKey, authCorporateImpersonateToken, Optional.of(idempotencyReference)));
    ...
    public void TransferFunds_SameIdempotencyRefDifferentPayload_PreconditionFailed() {
        ...
        final String corporateUserId = authenticatedCorporate.getLeft();
        CorporatesHelper.verifyKyb(secretKey, corporateUserId);
        final String authenticatedCorporateImpersonateToken = BackofficeHelper.impersonateIdentity(corporateUserId, IdentityType.CORPORATE, secretKey);
        ...
        BackofficeMultiService.transferFunds(transferFundsModel,
                        secretKey, authenticatedCorporateImpersonateToken, Optional.of(idempotencyReference))
                .then()
                .statusCode(SC_OK);

        BackofficeMultiService.transferFunds(transferFundsModel1,
                        secretKey, authenticatedCorporateImpersonateToken, Optional.of(idempotencyReference))
                .then()
    ...
    @Test
    public void TransferFunds_DifferentIdempotencyRef_Success() {
        ...
        final List<Response> responses = new ArrayList<>();
        responses.add(BackofficeMultiService.transferFunds(transferFundsModel,
                secretKey, authenticatedCorporateImpersonateToken, Optional.of(idempotencyReference)));
        responses.add(BackofficeMultiService.transferFunds(transferFundsModel,
                secretKey, authenticatedCorporateImpersonateToken, Optional.of(idempotencyReference1)));
        responses.add(BackofficeMultiService.transferFunds(transferFundsModel,
                secretKey, authenticatedCorporateImpersonateToken, Optional.empty()));
    ...
    public void TransferFunds_ManagedAccountStatement_Success() {
        ...
        assertSuccessfulTransfer(Pair.of(managedAccounts.get(0).getLeft(), MANAGED_ACCOUNTS),
                Pair.of(managedAccounts.get(1).getLeft(), MANAGED_ACCOUNTS), corporateCurrency, sendAmount, corporateImpersonateToken);
    ...
    public void TransferFunds_ManagedCardStatement_Success() {
        ...
        assertSuccessfulTransfer(Pair.of(managedCards.get(0).getLeft(), MANAGED_CARDS),
                Pair.of(managedCards.get(1).getLeft(), MANAGED_CARDS), consumerCurrency, sendAmount, consumerImpersonateToken);
    ...
    public void TransferFunds_NoDestinationInstrumentId_BadRequest(final String instrumentId) {
        ...
        BackofficeMultiService.transferFunds(transferFundsModel, secretKey, corporateImpersonateToken, Optional.empty())
                ...
                .statusCode(SC_BAD_REQUEST)
                .body("validationErrors[0].error", anyOf(is("HAS_TEXT"), is("REGEX")))
                .body("validationErrors[0].fieldName", equalTo("destination.id"));
    }
    ...
    public void TransferFunds_UnknownDestinationInstrumentType_BadRequest() {
        ...
        BackofficeMultiService.transferFunds(transferFundsModel, secretKey, corporateImpersonateToken, Optional.empty())
                ...
                .statusCode(SC_BAD_REQUEST)
                .body("validationErrors[0].error", equalTo("INVALID_TYPE_OR_VALUE"))
                .body("validationErrors[0].fieldName", equalTo("destination"))
                .body("validationErrors[1].error", equalTo("INVALID_TYPE_OR_VALUE"))
                .body("validationErrors[1].fieldName", equalTo("type"));
    }
    ...
    public void TransferFunds_CrossIdentityAuthenticationCheck_SourceNotFound() {
        ...
        BackofficeMultiService.transferFunds(transferFundsModel, secretKey, consumerImpersonateToken, Optional.empty())
                .then()
                .statusCode(SC_CONFLICT)
                .body("errorCode", equalTo("SOURCE_NOT_FOUND"));
    }
    ...
    public void TransferFunds_DestinationManagedAccountLimitReachedAndNotEnoughFundsNoFundMovements_Success() throws SQLException {
        ...
        final String impersonatedToken = BackofficeHelper.impersonateIdentity(corporate.getLeft(), IdentityType.CORPORATE, secretKey);

        BackofficeMultiService.transferFunds(transferFundsModel.build(), secretKey, impersonatedToken, Optional.empty())
                .then()
                .statusCode(SC_OK);
    ...
    public void TransferFunds_InvalidCurrency_BadRequest() {
        ...
        BackofficeMultiService.transferFunds(transferFundsModel, secretKey, consumerImpersonateToken, Optional.empty())
                ...
                .body("validationErrors[0].fieldName", equalTo("destinationAmount.currency"))
                .body("validationErrors[0].message", equalTo("destinationAmount.currency size must be between 3 and 3"));
    }
    ...
    public void TransferFunds_InvalidApiKey_Unauthorised(){
        ...
        BackofficeMultiService.transferFunds(transferFundsModel, "abc", consumerImpersonateToken, Optional.empty())
    ...
    public void TransferFunds_NoApiKey_BadRequest(){
        ...
        BackofficeMultiService.transferFunds(transferFundsModel, "", consumerImpersonateToken, Optional.empty())
    ...
    @Test
    public void TransferFunds_RootUserLoggedOut_Forbidden(){
        ...
        BackofficeMultiService.transferFunds(transferFundsModel, secretKey, token, Optional.empty())
                .then().statusCode(SC_FORBIDDEN);
    }

    @Test
    public void TransferFunds_CorporateAuthToken_Forbidden() {
        ...
        BackofficeMultiService.transferFunds(transferFundsModel, secretKey, corporateAuthenticationToken, Optional.empty())
                .then()
                .statusCode(SC_FORBIDDEN);
    }

    @Test
    public void TransferFunds_ConsumerAuthToken_Forbidden() {
        ...
        BackofficeMultiService.transferFunds(transferFundsModel, secretKey, consumerAuthenticationToken, Optional.empty())
                .then()
                .statusCode(SC_FORBIDDEN);
    }
    @Test
    public void TransferFunds_CorporateUserToken_Forbidden(){
        final Long depositAmount = 10000L;
        ...
        final TransferFundsModel transferFundsModel =
                TransferFundsModel.newBuilder()
                        ...
                        .setDestination(new ManagedInstrumentTypeId(managedAccounts.get(1).getLeft(), MANAGED_ACCOUNTS))
                        .build();
        BackofficeMultiService.transferFunds(transferFundsModel, secretKey, user.getRight(), Optional.empty())
                .then()
                .statusCode(SC_FORBIDDEN);
    }
