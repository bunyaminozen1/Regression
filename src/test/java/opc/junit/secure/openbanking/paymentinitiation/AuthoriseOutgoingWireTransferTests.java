...
public class AuthoriseOutgoingWireTransferTests extends BaseSetup {
    ...
    public void AuthoriseOwt_Corporate_Success(final Currency currency, final OwtType type) throws Exception {
        ...
        final ValidatableResponse response =
                OpenBankingSecureService.authorisePayment(sharedKey, corporateAuthenticationToken, tppId, payment.getLeft())
                .then()
                .statusCode(SC_OK);
    ...
    public void AuthoriseOwt_Consumer_Success(final Currency currency, final OwtType type) throws Exception {
        ...
        final ValidatableResponse response =
                OpenBankingSecureService.authorisePayment(sharedKey, consumerAuthenticationToken, tppId, payment.getLeft())
                        .then()
                        .statusCode(SC_OK);
