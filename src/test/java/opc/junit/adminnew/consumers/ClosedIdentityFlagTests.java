...
public class ClosedIdentityFlagTests extends BaseConsumersSetup{
    ...
    public void IdentityClosureFlag_GetAllConsumers_Success(){
        ...
        AdminService.getConsumers(filterModel, impersonatedAdminToken)
                .then()
                .statusCode(SC_OK)
    ...
    public void IdentityClosureFlag_GetConsumer_Success(){
        ...
        AdminService.getConsumer(consumer.getLeft(), impersonatedAdminToken)
                .then()
                .statusCode(SC_OK)
    ...
    public void IdentityClosureFlag_UpdateConsumer_Success(){
        ...
        AdminService.updateConsumer(updateConsumerModel, impersonatedAdminToken, consumer.getLeft())
                .then()
                .statusCode(SC_OK)
                .body("id.id", equalTo(consumer.getLeft()))
    ...
    public void IdentityClosureFlag_ActivateConsumer_ClosedIdentity(){
        AdminService.activateConsumer(new ActivateIdentityModel(true), consumer.getLeft(), impersonatedAdminToken)
                .then()
    ...
    public void IdentityClosureFlag_ActivateConsumerUser_ClosedIdentity(){
        ...
        AdminService.activateConsumerUser(consumer.getLeft(), consumer.getLeft(), impersonatedAdminToken)
                .then()
                .statusCode(SC_CONFLICT)
                .body("errorCode", equalTo("CLOSED_IDENTITY"));

        //Try to activate authorized user
        AdminService.activateConsumerUser(consumer.getLeft(), authorizedUser.getLeft(), impersonatedAdminToken)
                .then()
                .statusCode(SC_CONFLICT)
                .body("errorCode", equalTo("CLOSED_IDENTITY"));
    }
