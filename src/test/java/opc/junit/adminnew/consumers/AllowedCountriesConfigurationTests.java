...
public class AllowedCountriesConfigurationTests extends BaseConsumersSetup{
    ...
    public void Consumer_AllowedCountriesSetInProgrammeAndProfileLevelCheckOtherProgramme_Success(final CountryCode countryCode){

        updateCountriesOnProgrammeLevel(UpdateAllowedCountriesModel.builder().country(List.of("MT", "IT", "BG")).build());
    ...
    public void setCountriesEmptyList(){
        ...
        final UpdateAllowedCountriesModel updateProgrammeModel = UpdateAllowedCountriesModel.builder()
                .country(getAllEeaCountries())
                .hasCountry(true)
                .build();
    ...
    private void updateCountriesOnProgrammeLevel(final UpdateAllowedCountriesModel updateAllowedCountriesModel){
        AdminService.updateProgramme(updateAllowedCountriesModel, programmeId, impersonatedAdminToken)
                .then()
                .statusCode(SC_OK);
    }

    private void updateCountriesOnProfileLevel(final UpdateConsumerProfileModel updateConsumerProfileModel){
        AdminService.updateConsumerProfile(updateConsumerProfileModel, impersonatedAdminToken, programmeId, consumerProfileId)
                .then()
                .statusCode(SC_OK);
    }
}
