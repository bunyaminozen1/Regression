...
public class AllowedCountriesConfigurationTest extends BaseCorporatesSetup{
    ...
    public void setCountriesEmptyList(){
        ...
        final UpdateAllowedCountriesModel updateAllowedCountriesModel = UpdateAllowedCountriesModel.builder()
                .country(getAllEeaCountries())
                .hasCountry(true)
                .build();

        updateCountriesOnProgrammeLevel(updateAllowedCountriesModel);
