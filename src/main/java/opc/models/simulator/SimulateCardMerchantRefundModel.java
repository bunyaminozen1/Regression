...
public class SimulateCardMerchantRefundModel {
    ...
    public SimulateCardMerchantRefundModel(final Builder builder) {
    ...
    public static class Builder {
        ...
        public SimulateCardMerchantRefundModel build() { return new SimulateCardMerchantRefundModel(this); }
    }
