...
public class SimulateCardPurchaseModel {
    ...
    public SimulateCardPurchaseModel(final Builder builder) {
    ...
    public static class Builder {
        ...
        public SimulateCardPurchaseModel build() { return new SimulateCardPurchaseModel(this); }
    }
