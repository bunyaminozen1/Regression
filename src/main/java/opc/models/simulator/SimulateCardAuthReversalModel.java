...
public class SimulateCardAuthReversalModel {
    ...
    public SimulateCardAuthReversalModel(final Builder builder) {
    ...
    public static class Builder {
        ...
        public SimulateCardAuthReversalModel build() { return new SimulateCardAuthReversalModel(this); }
    }
