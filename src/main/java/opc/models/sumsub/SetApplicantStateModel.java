...
public class SetApplicantStateModel {
    ...
    public SetApplicantStateModel(final Builder builder) {
    ...
    public static class Builder {
        ...
        public SetApplicantStateModel build() { return new SetApplicantStateModel(this); }
    }
